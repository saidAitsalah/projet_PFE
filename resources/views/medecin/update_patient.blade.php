...
<div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
      ...
      <div class="container-fluid page-body-wrapper">
            ...
            <ul class="navbar-nav w-100">
              <li class="nav-item w-100" >
                <form action="{{url('patient_search')}}"  class="nav-link mt-2 mt-md-0 d-none d-lg-flex search">
                  <input type="text"   name="name" style="  color:white;" class="form-control" placeholder="chercher un membre">
                </form>
              </li>
            </ul>
        ...
        <form action="{{url('editpatient',$data->id)}}" method="POST" enctype="multipart/form-data" style="opacity: 0.8; padding: 30px 25px; border radius: 5px; margin: auto;">
                  @csrf
                  <legend> informations administratives </legende>
                  <div class="custom" style=" background-color:rgb(0,0,0,0.5);" >
                      <div style="color:black;" >
                     
                      <div  style="padding:15px; margin: 90px auto ; "> 
                 <label style="color:white; ">  Photo du patient</label>
                 <img     src="patientimage/{{$data->photo}}"   >
             ...
             <div style="padding:15px;"> 
                 ...
                 <input type="text" style="width: 250px;" name="name" value="{{$data->nom}}" style="  color:black;" placeholder="Ecrire le nom" required=""> 
             </div>

             <div style="padding:15px;"> 
                 <label style="color:white;">telephone: </label>
                 <input type="number" style="width: 250px;" name="number" value="{{$data->telephone}}" style="  color:black;" placeholder="Ecrire votre numero" required=""> 
             </div>
             ...
             <div style="padding:15px;"> 
                 ...
                 <input type="text" style="width: 250px;" value="{{$data->nationnalité}}" name="nationnalité" style="  color:black;" placeholder="Votre nationnalité" required=""> 
             </div>

             <div style="padding:15px;"> 
                 <label style="color:white;"> Date de naissance </label>
                 <input type="date" style="width: 250px;" value="{{$data->dateNa}}" name="dateN" style="color:black;" placeholder="Votre date de naissance" required=""> 
             </div>

             <div style="padding:15px;"> 
                 <label style="color:white;"> Lieu de naissance </label>
                 <input type="lieuN" style="width: 250px;" value="{{$data->lieuN}}" name="mail" style="color:black;" placeholder="lieu de naissance" required=""> 
             </div>

             <div style="padding:15px;"> 
                 <label style="color:white;"> Sexe </label>
                 <div>
  <input type="radio" id="homme" name="sexe" value="{{$data->sexe}}" value="homme"
         checked>
  <label for="homme">Homme</label>
</div>

<div>
  <input type="radio" id="femme" name="sexe" value="{{$data->sexe}}" value="femme">
  <label for="femme">Femme</label>
</div>

<div>
  <input type="radio" id="autre" name="sexe" value="{{$data->sexe}}" value="autre">
  <label for="autre">Autre</label>
             ...
             <div style="padding:15px;"> 
                 ...
                 <input type="text" style="width: 250px;" value="{{$data->adresse}}" name="adresse" style="color:black;" placeholder="Ecrire votre adresse" required=""> 
             </div>

             <div style="padding:15px;"> 
                 <label style="color:white;"> Email </label>
                 <input type="email" style="width: 250px;" name="mail" value="{{$data->email}}" style="color:black;" placeholder="Ecrire votre mail" required=""> 
             </div>
...
<legend> informations medicales </legende>
                 ...
                 <input type="text" style="width: 250px;" value="{{$data->nomMedecin}}" name="medcin" style="color:black;" placeholder="le nom du medecin" required=""> 
             </div>

             <div style="padding:15px;"> 
                 <label style="color:white;"> groupe-sanguin</label>
                 <input type="text" style="width: 250px;" value="{{$data->groupeSanguin}}" name="groupe_sanguin" style="color:black;" placeholder="le groupe-sanguin" required=""> 
             </div>

             <div style="padding:15px;"> 
                 <label style="color:white;">couverture-sociale </label>
                 <select name="couvertureS" style="width: 250px;" value="{{$data->couvS}}"   style=" color:black; width:200px;" required="">
             ...
             <div style="padding:15px;"> 
                 ...
                 <input type="file" style="width: 250px;" value="{{$data->analyse}}"  name="radio"  placeholder="uploader"style="color:black;" required=""> 
             </div>

             <div style="padding:15px;"> 
                 <label style="color:white;"> maladies-chroniques</label>
                 <input type="text" style="width: 250px;" value="{{$data->maladie}}" name="maladies" style="color:black;" placeholder="type de maladies" required=""> 
             </div>

             <div style="padding:15px;"> 
                 <label style="color:white;"> Rapport-état </label>
                 <textarea type="text"  name="rapport" value="{{$data->rapport}}" style="color:black;" required="">rapport de santé-physique</textarea>
             
                </div>

             <div style="padding:15px;"> 
                 <label style="color:white;"> préscription-médicaments </label>
                 <input type="text" name="medicament" value="{{$data->medicament}}" style="width: 250px;" placeholder="nom des medicaments" style=" color:black; width:200px;" required="">
