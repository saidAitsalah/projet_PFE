      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <table >
                  <tr style="color:black; background-color:white;"> 
                      ...
                      <th style="padding:10px;"> Nationnalité</th>
                      <th style="padding:10px;"> Sexe</th>
                      <th style="padding:10px;"> Couverture_sociale</th>
                      <th style="padding:10px;"> Photo</th>
                      <th style="padding:10px;"> Analyses</th>
                      <th style="padding:10px;"> Archiver</th>
                  ...
                  <tr align="center"  style="background-color:rgb(0,0,0,0.2);"> 
                      <th style=" color: white; padding:10px;"> {{$patient->nom}}  </th>
                      <th style="color: white; padding:10px;"> {{$patient->telephone}}   </th>
                      <th style="color: white; padding:10px;"> {{$patient->nomMedecin}}  </th>
                      <th style="color: white; padding:10px;"> {{$patient->nationnalité}}   </th>
                      <th style="color: white; padding:10px;"> {{$patient->sexe}}    </th>
                      <th style="color: white; padding:10px;">  {{$patient->couvS}}  </th>
                      <th style="color: white; padding:10px;"> <img height="100" width="100" src="patientimage/{{$patient->photo}}"> </th>
                      <th style="color: white; padding:10px;"> <img height="100" width="100" src="analyseimage/{{$patient->analyse}}"> </th>
                      <th style="padding:10px;"> 
                      <a class="btn btn-success" href="{{url('delete_patient',$patient->id)}}">Archiver </a>
                      </th>
                      <th style="padding:10px;"> 
                      <a class="btn btn-danger" href="{{url('update_patient',$patient->id)}}">Modifier</a>
                      </th>
