      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <table >
                  ...
                  <tr align="center" style="background-color:rgb(0,0,0,0.2);"> 
                      <th style="color: white; padding:10px;"> {{$res->nom}}  </th>
                      <th style="color: white; padding:10px;"> {{$res->telephone}}   </th>
                      <th style="color: white; padding:10px;"> {{$res->nomMedecin}}  </th>
                      <th style="color: white; padding:10px;"> {{$res->nationnalité}}   </th>
                      <th style="color: white; padding:10px;"> {{$res->sexe}}    </th>
                      <th style="color: white; padding:10px;">  {{$res->couvS}}  </th>
                      <th style="color: white; padding:10px;"> <img height="100" width="100" src="patientimage/{{$res->photo}}"> </th>
                      <th style="color: white; padding:10px;"> <img height="100" width="100" src="analyseimage/{{$res->analyse}}"> </th>
                      <th style="color: white; padding:10px;"> <a href="{{url('afficher',$res->id)}}" class="btn btn-primary"> Consulter</a> </th>
